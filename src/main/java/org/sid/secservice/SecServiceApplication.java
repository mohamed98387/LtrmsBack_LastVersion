...
public class SecServiceApplication {
  ...
  //  @Bean
   //CommandLineRunner start(AccountService accountService){
    //    return args ->{
    //       accountService.addNewRole(new AppRole(null,"RH_SEGMENT"));
     //      accountService.addNewRole(new AppRole(null,"ADMIN"));
     //    accountService.addNewRole(new AppRole(null,"CHEF_SEGMENT"));
     //      accountService.addNewRole(new AppRole(null,"RESPONSABLE_TRANSPORT"));
